...
- Downreg in acute vs subacute for both C
- Downreg in acute C imp vs non-imp (~10 & 6 fc)
- less abundant in Ds, more abundant in C non-imp vs A
...
- Future studies modelling SCI outcomes may wish to incorporate ApoE variant as a factor should gene seq become ubiquitous

### ProteinPilot data

- Downreg in acute Cs vs subacute, both groups, imp gap bigger
- upreg in A and D relative to both acute Cs
- less abundant in subacute imp vs non-imp - may be reflective of severity
...
- bottom bar: up in acute c imps vs non-imps
...
```{r, label='print-bib-cont-2', results="asis"}
